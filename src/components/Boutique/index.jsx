...
import { Tabs, notification } from 'antd'; // Ajout de la notification
import './boutique.css';
...
const Boutique = () => {
  ...
  const showNotification = (message, type = 'success') => {
    const config = {
      ...
      closeIcon: <CloseCircleOutlined style={{ color: 'white' }} />, // Ajoutez cette ligne pour définir la couleur de la croix
    };
