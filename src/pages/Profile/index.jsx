  ...
  return (
    <section className="max-w-2xl mx-auto mt-8 bg-gray-800 shadow-xl rounded-lg text-gray-900">
      ...
      <article className="p-4 mt-2 flex flex-wrap justify-center gap-4">
        ...
        <div>
          <a href="/mescommandes" className="bg-gray-500 hover:bg-gray-400 text-white font-semibold py-2 px-4 rounded focus:outline-none focus:shadow-outline text-sm">
            Mes Commandes
          </a>
        </div>
        <div>
